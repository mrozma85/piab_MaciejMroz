...
namespace Projekt.Intranet.Controllers
{
    public class KontaktController : Controller
    {
        ...
        public KontaktController(ProjektIntranetContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdKontaktu,TrescKontaktu,Pozycja")] Kontakt kontakt)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdKontaktu,TrescKontaktu,Pozycja")] Kontakt kontakt)
        {
